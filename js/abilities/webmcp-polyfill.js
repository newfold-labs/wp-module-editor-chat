...
/**
 * @return {{ available: boolean, polyfillLoaded: boolean, secureContext: boolean }} The current WebMCP environment status.
 */
export function getWebMCPStatus() {
	...
	return {
		available,
		polyfillLoaded: typeof window !== "undefined" && !!window.WebMCPPolyfill,
		secureContext,
	};
}
