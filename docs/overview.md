...
- **Content creation (v1)** — Create new pages, posts, and CPTs as drafts from the chat. Pages open automatically in the editor preview; other types include an edit link in the reply.
